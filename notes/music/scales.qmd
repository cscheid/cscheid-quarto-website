...
|------|-----------------------|-------|-|-|-|-|-|-|-|
| Lydian     | 4 | C | D  |E   | F♯ | G  | A  | B  |<button class="btn btn-quarto" onclick="">Play</button>|
| Ionian     | 1 | C | D  |E   | F  | G  | A  | B  |<button class="btn btn-quarto" onclick="">Play</button>|
| Mixolydian | 5 | C | D  |E   | F  | G  | A  | B♭ |<button class="btn btn-quarto" onclick="">Play</button>|
| Dorian     | 2 | C | D  |E♭  | F  | G  | A  | B♭ |<button class="btn btn-quarto" onclick="">Play</button>|
| Aeolian    | 6 | C | D  |E♭  | F  | G  | A♭ | B♭ |<button class="btn btn-quarto" onclick="">Play</button>|
| Phrygian   | 3 | C | D♭ | E♭ | F  | G  | A♭ | B♭ |<button class="btn btn-quarto" onclick="">Play</button>|
| Locrian    | 7 | C | D♭ | E♭ | F  | G♭ | A♭ | B♭ |<button class="btn btn-quarto" onclick="">Play</button>|
...
```{ojs}
scaleButton([0, 2, 3, 5, 7, 8, 10, 12], "Aeolian (\"Minor\")")
scaleButton([0, 2, 3, 5, 7, 8, 11, 12], "Harmonic Minor")
```
...
```{ojs}
scaleButton([0, 1, 4, 5, 7, 8, 10, 12], "Phrygian Dominant")
scaleButton([0, 1, 3, 5, 7, 8, 10, 12], "Phrygian")
```
